...
public interface SysCodeMapper extends BaseMapper<SysCode> {
     ...
     * 获取所有部门列表
     */
    Page<Map<String, Object>> list(@Param("page") Page page, @Param("condition") String condition, @Param("codeId") Long codeId);
     ...
     * where pids like ''
     */
    List<SysCode> likePids(@Param("codeId") Long codeId);
}
