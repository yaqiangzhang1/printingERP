 ...
 */
public class MaterielWrapper extends BaseControllerWrapper {

    public MaterielWrapper(Map<String, Object> single) {
        super(single);
    }

    public MaterielWrapper(List<Map<String, Object>> multi) {
        super(multi);
    }

    public MaterielWrapper(Page<Map<String, Object>> page) {
        super(page);
    }

    public MaterielWrapper(PageResult<Map<String, Object>> pageResult) {
        super(pageResult);
    }
